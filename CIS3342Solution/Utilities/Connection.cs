...
namespace Utilities
{
    ...
    {
        String SqlConnectString = "server=cis-mssql1.temple.edu;Database=fa14_3342_tud03191;User id=tud03191;Password=ohT1eewo";
        //String SqlConnectString = "server=69.72.30.20;Database=tipsybar_CIS3342;User id=tipsybar_billz;Password=abc123$%^";
